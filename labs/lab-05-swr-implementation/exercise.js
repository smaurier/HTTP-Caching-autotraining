...
class SWRCache {
  constructor() {
    ...
    // 💡 this.store = new Map();
    // 💡 this.metrics = { hits: 0, misses: 0, staleServes: 0, revalidations: 0 };
    // 💡 this.pendingRevalidations = new Map(); // pour le coalescing
  }
...
async function slowDataSource(shouldFail = false) {
  fetchCount++;
